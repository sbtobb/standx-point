[API](https://docs.standx.com/standx-api/standx-api "API") Perps WebSocket API
...
## Connection Management [Permalink for this section](https://docs.standx.com/standx-api/perps-ws\#connection-management)

Both WebSocket streams implement the following connection management behavior:

### Connection Duration Limit [Permalink for this section](https://docs.standx.com/standx-api/perps-ws\#connection-duration-limit)
...
### Ping/Pong Mechanism [Permalink for this section](https://docs.standx.com/standx-api/perps-ws\#pingpong-mechanism)
...
## Market Stream [Permalink for this section](https://docs.standx.com/standx-api/perps-ws\#market-stream)

Base Endpoint: `wss://perps.standx.com/ws-stream/v1`

### Available Channels [Permalink for this section](https://docs.standx.com/standx-api/perps-ws\#available-channels)
...
### Subscribe to Depth Book [Permalink for this section](https://docs.standx.com/standx-api/perps-ws\#subscribe-to-depth-book)
...
### Subscribe to Symbol Price [Permalink for this section](https://docs.standx.com/standx-api/perps-ws\#subscribe-to-symbol-price)
...
### Authentication Request [Permalink for this section](https://docs.standx.com/standx-api/perps-ws\#authentication-request)

#### Log in with JWT [Permalink for this section](https://docs.standx.com/standx-api/perps-ws\#log-in-with-jwt)
...
#### User Orders Subscription [Permalink for this section](https://docs.standx.com/standx-api/perps-ws\#user-orders-subscription)
...
#### User Position Subscription [Permalink for this section](https://docs.standx.com/standx-api/perps-ws\#user-position-subscription)
...
#### User Balance Subscription [Permalink for this section](https://docs.standx.com/standx-api/perps-ws\#user-balance-subscription)
...
## Order Response Stream [Permalink for this section](https://docs.standx.com/standx-api/perps-ws\#order-response-stream)
...
### Request Structure [Permalink for this section](https://docs.standx.com/standx-api/perps-ws\#request-structure)
...
### Methods [Permalink for this section](https://docs.standx.com/standx-api/perps-ws\#methods)

#### `auth:login` [Permalink for this section](https://docs.standx.com/standx-api/perps-ws\#authlogin)
...
#### `order:new` [Permalink for this section](https://docs.standx.com/standx-api/perps-ws\#ordernew)

Create a new order. Parameters are the same as the HTTP API `new_order` payload.

#### `order:cancel` [Permalink for this section](https://docs.standx.com/standx-api/perps-ws\#ordercancel)

Cancel an existing order. Parameters are the same as the HTTP API `cancel_order` payload.

### Order Response Format [Permalink for this section](https://docs.standx.com/standx-api/perps-ws\#order-response-format)
